...
const resources = {
  ru: {
    translation: {
      ...
      'chat.messagesCount_few': '{{count}} сообщения',
      'chat.messagesCount_many': '{{count}} сообщений',
    },
  },
}

// Создаём отдельный экземпляр i18n
const i18nInstance = i18n.createInstance()

// Инициализируем экземпляр (асинхронно, но с синхронными ресурсами)
const initPromise = i18nInstance.use(initReactI18next).init({
  resources,
  lng: 'ru',
  fallbackLng: 'ru',
  interpolation: {
